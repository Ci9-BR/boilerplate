        ...
        rules: {
            ...
            'i18next/no-literal-string': ['error', {
                ...
                ignoreFunctions: [
                    'Logger.*',
                    'ConfigService.get',
                    'ApiProperty', 'ApiOperation', 'ApiTags', 'ApiBody', 'ApiResponse',
                    'Controller', 'Get', 'Post', 'Put', 'Delete', 'Patch',
                    'setGlobalPrefix', 'setTitle', 'setDescription', 'setVersion', 'addTag', 'setup',
                    'forRoot', 'register',
                    'findUnique', 'create', 'update', 'upsert', 'delete', 'findMany', 'findFirst',
                    'send', 'publish', 'putItem', 'getItem', 'upload', 'get',
                    'listen', 'getUrl',
                    'logOperation', 'handleError', 'recordMetric', 'startTrace'
                ]
            }],
